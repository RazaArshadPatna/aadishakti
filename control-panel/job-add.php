...
if(isset($_GET['id'])){
    $auto_Fill=true;    
    $id=$_GET['id'];
    $sql="SELECT `id`, `heading`, `content`,`title`, `entry_time`, `entry_by`, `media`, `status` FROM `manage_job` where id=?";
	 $s=$conn->prepare($sql);
	 $s->bind_param("s",$id);
	 $s->bind_result($edit_id,$page_menu,$content,$title,$entry_time,$entry_by,$media1,$status);
	 if($s->execute()){
		 $s->fetch();
		 $s->close();
	 }
            ...
            <div class="container">
                <div class="row g-3 mb-3 align-items-center">
                    ...
                    <div class="col text-md-end">
                        <a class="btn btn-primary" href="job-dis.php"><i
                ...
                <div class="row g-3 clearfix row-deck">
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            ...
                            <form id="myForm" role="form" action="action/job.php" method="post"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <?php if($auto_Fill){ ?>
                                        <div class="col-md-12">
                                            <img height="70" width="70" src="../upload/job/<?php echo $media1; ?>" />
                                        </div>
