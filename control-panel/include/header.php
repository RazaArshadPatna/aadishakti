      ...
      <div class="container-fluid">
        <nav class="navbar">
          ...
          <div class="d-flex">
            ...
            <a href="./index.php" class="brand-icon d-flex align-items-center mx-2 mx-sm-3 text-primary">
             <img src="<?php if(!empty($logo)){ echo '../upload/logo/'.$logo;}else{echo './assets/img/profile_av.png';}?>" class="user-image" alt="logo" style="height:50px;">
            </a>
          </div>
          <!-- start: search area -->
            ...
            <li>
              <div class="dropdown morphing scale-left user-profile mx-lg-3 mx-2">
                <a class="nav-link dropdown-toggle rounded-circle after-none p-0" href="#" role="button" data-bs-toggle="dropdown">
                  <img class="avatar img-thumbnail rounded-circle shadow" src="<?php if(!empty($usermedia)){ echo '../upload/admin/'.$usermedia;}else{echo './assets/img/profile_av.png';}?>" alt="">
                </a>
                <div class="dropdown-menu border-0 rounded-4 shadow p-0">
                  <div class="card border-0 w240">
                    <div class="card-body border-bottom d-flex">
                      <img class="avatar rounded-circle" src="<?php if(!empty($usermedia)){ echo '../upload/admin/'.$usermedia;}else{echo './assets/img/profile_av.png';}?>" alt="">
                      <div class="flex-fill ms-3">
                        <h6 class="card-title mb-0"><?php echo $_SESSION['name_admin']; ?></h6>
                        <!--<span class="text-muted">alliegrater@luno.com</span>-->
                      </div>
                    </div>
                    <div class="list-group m-2 mb-3">
                      <a class="list-group-item list-group-item-action border-0" href="administration-change-password.php"><i class="w30 fa fa-gear"></i>Change Password</a>
                     <!-- <a class="list-group-item list-group-item-action border-0" href="administration-admin-user-add.php"><i class="w30 fa fa-users"></i>Manage Team</a> -->
                      
                      
                    </div>
                    <a href="logout.php" class="btn bg-secondary text-light text-uppercase rounded-0">Sign out</a>
                  </div>
                </div>
              </div>
            </li>
