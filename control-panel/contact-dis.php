      ...
      <div class="container">
        <div class="row g-3 mb-3 align-items-center">
         ...
         <div class="col text-md-end">
           <button class="btn btn-danger" onClick="Trush('contact_us')"><i class="fa fa-trash"></i></button>
          ...
          <div class="col-lg-12 col-md-12">
            <div class="card">
              ...
              <tbody>
                 ...
                 <?php 
				 $i=1;
				 $sql="SELECT `id`, `Name`, `mobile`, `Email`, `Details`, `subject`, `entry_time` FROM `contact_us`";
