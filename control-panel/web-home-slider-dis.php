      ...
      <div class="container">
        <div class="row g-3 mb-3 align-items-center">
          ...
          <div class="col text-md-end">
            <a class="btn btn-primary" href="web-home-slider-add.php"><i class="fa fa-plus me-2"></i>Add</a>
            <button class="btn btn-danger btn-flat" onClick="Trush('banner')"><i class="fa fa-trash"></i></button>
		  </div>
        </div>
      </div>
    </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <tbody id="result">
                 <?php 
                 $i=1;
                 $sql="SELECT `id`, `image`, `heading1`, `heading2`, `heading3`, `show_button`, `url`, `status`, `entry_by`, `entry_time`, `city_id` FROM `banner`";
                 $s=$conn->prepare($sql);
                 $s->bind_result($id,$image,$heading1,$heading2,$heading3,$show_button,$url,$status,$entry_by,$entry_time,$city_id);
                 if($s->execute()){
                     $s->store_result();
                     while($s->fetch()){
                ...
                <tr id="row<?php echo $id; ?>">
                    ...
                    <td class="center"><a href="web-home-slider-add.php?id=<?php echo $id; ?>"><button class="btn btn-primary"><i class="fa fa-edit"></i></button></a></td>
