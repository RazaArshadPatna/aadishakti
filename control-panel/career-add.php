...
if(isset($_GET['id'])){
     $auto_Fill=true;    
     $id=$_GET['id'];
     $sql="SELECT `id`,`heading1`,`title`,`entry_time`,`entry_by`,`status`,`media` FROM `career` WHERE id=?";
     $s=$conn->prepare($sql);
     $s->bind_param("s",$id);
            ...
            <div class="container">
                <div class="row g-3 mb-3 align-items-center">
                    ...
                    <div class="col text-md-end">
                        <a class="btn btn-primary" href="career-dis.php"><i
                ...
                <div class="row g-3 clearfix row-deck">
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            ...
                            <form id="myForm" role="form" action="action/career.php" method="post"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <?php } ?>
                                        <div class="col-md-12" >
                                            <label for="exampleInputEmail1">Upload File<span class="label label-danger" id="pf_error">(Upload Pdf only)</span></label>
                                            ...
                                            <?php if($auto_Fill){ ?>
                                            <div class="col-md-12" ">
                                            <label for="exampleInputEmail1">Old File</label>
                                                <a href="../upload/doc/<?php echo $media1;?>" target="_blank"><i class="fa fa-file fa-2x" aria-hidden="true"></i></a>
                                            </div>
