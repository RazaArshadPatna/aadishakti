...
if(isset($_GET['id'])){
     $auto_Fill=true;    
     $id=$_GET['id'];
     $sql="SELECT `id`,`heading1`,`amount`,`entry_time`,`entry_by`,`status`,`media` FROM `master_dis_reg_amount` WHERE id=?";
     $s=$conn->prepare($sql);
     $s->bind_param("s",$id);
     $s->bind_result($edit_id,$heading1,$amount,$entry_time,$entry_by,$status,$media1);
     if($s->execute()){
            ...
            <div class="container">
                <div class="row g-3 mb-3 align-items-center">
                    ...
                    <div class="col text-md-end">
                        <a class="btn btn-primary" href="master-dis-reg-dis.php"><i
                ...
                <div class="row g-3 clearfix row-deck">
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            ...
                            <form id="myForm" role="form" action="action/master-dis-reg-amount.php" method="post"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <label for="exampleInputEmail1">Amount<span class="label label-danger"
                                                    id="pf_error"></span></label>
                                            <input type="text" name="amount" value="<?php if(!empty($amount)){ echo $amount;} ?>"
                                                class="form-control" />
                                        </div>
