...
/* page info */
$form_title="Master Register Amount";
$module="Master";
?>
...
<body class="layout-1" data-luno="theme-blue">
      ...
      <div class="container">
        <div class="row g-3 mb-3 align-items-center">
          ...
          <div class="col text-md-end">
            <a class="btn btn-primary" href="master-reg-amount-add"><i class="fa fa-plus me-2"></i>Add</a>
          <button class="btn btn-danger btn-flat" onClick="Trush('master_reg_amount')"><i class="fa fa-trash"></i></button>
		  </div>
        </div>
      </div>
    </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <tbody id="result">
                 <?php 
                 $i=1;
                 $sql="SELECT `id`,`heading1`,`amount`,`entry_time`,`entry_by`,`status`,`media` FROM `master_reg_amount` WHERE 1";
                 $s=$conn->prepare($sql);
                ...
                <tr id="row<?php echo $id; ?>">
                    ...
                    <td class="center"><a href="master-reg-amount-add.php?id=<?php echo $id; ?>"><button class="btn btn-primary"><i class="fa fa-edit"></i></button></a></td>
  ...
  <script>
        ...
        $('.menu-web-master-reg').addClass("active");
</script>
 <script>
