      ...
      <div class="container">
        <div class="row g-3 mb-3 align-items-center">
          ...
          <div class="col text-md-end">
            <a class="btn btn-primary" href="web-static-pages-add.php"><i class="fa fa-plus me-2"></i>Add</a>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <tr id="row<?php echo $id; ?>" >
					...
					<td class="center"><a href="web-static-pages-add.php?id=<?php echo $id; ?>"><button class="btn btn-primary"><i class="fa fa-edit"></i></button></a></td>
