...
if(isset($_GET['id'])){
     $auto_Fill=true;    
     $id=$_GET['id'];
     $sql="SELECT `id`, `image`, `heading1`, `heading2`, `heading3`, `show_button`, `url`, `status`, `entry_by`, `entry_time`, `city_id` FROM `brand` WHERE id=?";
     $s=$conn->prepare($sql);
     $s->bind_param("s",$id);
      ...
      <div class="container">
        <div class="row g-3 mb-3 align-items-center">
          ...
          <div class="col text-md-end">
            <a class="btn btn-primary" href="brand-dis.php"><i class="fa fa-long-arrow-left me-2"></i>View</a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row g-3 clearfix row-deck">
          <div class="col-lg-12 col-md-12">
            <div class="card">
			  ...
			  <form id="myForm" role="form" action="action/brand.php" method="post" enctype="multipart/form-data">
              <div class="card-body">
                ...
                <div class="col-md-12">
                  ...
                  <input type="file" class="form-control" name="logo_70" id="logo_70"   ><span>(Choose 1920x550 size for image)</span>
				  
                </div>
                  
                  <?php if($auto_Fill){ ?>
                  <div class="col-md-12">
                     <img height="70" width="70" src="../upload/brand/<?php echo $image; ?>" />
                  </div>
