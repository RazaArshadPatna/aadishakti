      ...
      <div class="container">
        <div class="row g-3 mb-3 align-items-center">
          ...
          <div class="col text-md-end">
            <a class="btn btn-primary" href="administration-admin-user-add.php"><i class="fa fa-long-arrow-left me-2"></i>Add</a>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <tbody>
				 ...
				 $sql="SELECT `id`, `admin_id`, `email`, `color`, `mobile`, `last_login`, `dob`, `username`, `roll`, `serial`, `shop_id`,`aadhaar` FROM `admin_member`";

                 $s=$conn->prepare($sql);

                 $s->bind_result($id,$admin_id,$email,$color,$mobile,$last_login,$dob,$username,$roll,$serial,$shop_id,$aadhaar);
	            ...
	            <td><?php echo $username;?></td>
                    ...
                    <td class="center"><a href="administration-admin-user-add.php?id=<?php echo $id; ?>"><button class="btn btn-primary"><i class="fa fa-pencil"></i></button></a></td>
