      ...
      <div class="container">
        <div class="row g-3 mb-3 align-items-center">
          ...
          <!-- <div class="col text-md-end">
            <a class="btn btn-primary" href="job-add.php"><i class="fa fa-plus me-2"></i>Add</a>
          </div> -->
        </div>
      </div>
    </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <tbody id="result">
                 <?php 
                 $i=1;
                  $sql="SELECT `id`, `heading`, `content`, `entry_time`, `entry_by` FROM `manage_job`";
                 $s=$conn->prepare($sql);
                ...
                <tr id="row<?php echo $id; ?>" >
					...
					<td class="center"><a href="job-add.php?id=<?php echo $id; ?>"><button class="btn btn-primary"><i class="fa fa-edit"></i></button></a></td>
