      ...
      <div class="container">
        <div class="row g-3 mb-3 align-items-center">
          ...
          <div class="col text-md-end">
            <a class="btn btn-primary" href="project-add.php"><i class="fa fa-long-arrow-left me-2"></i>Add</a>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-lg-12 col-md-12">
            <div class="card">
              ...
              <tbody>
				 ...
				 $sql="SELECT `id`, `name`, `type`,`media`, `cdate`, `cby` FROM `project`";
                 $s=$conn->prepare($sql);
                 $s->bind_result($id,$name,$type,$img,$cdate,$cby);
                 if($s->execute()){
				   while($s->fetch()){
                ...
                <tr class="gradeX" id="row<?php echo $id; ?>">   
                    ...
                    <td><img src="../upload/project/<?php echo $img; ?>" class="img-table" width="50" height="50" /></td>
                    <td><?php echo CusDate($cdate); ?></td>
                    <td><?php echo $cby; ?></td>
                    <td class="center"><a href="project-add.php?id=<?php echo $id; ?>"><button class="btn btn-primary"><i class="fa fa-edit"></i></button></a></td>
                </tr>
                <?php $i++;     
                     }
