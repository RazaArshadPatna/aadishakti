...
if(isset($_GET['id'])){
    ...
    $id=$_GET['id'];
	$edit_id=$_GET['id'];
    $sql="SELECT `id`,`name`, `post`, `details`,`media`,`rel_date` FROM `our_team` where id=?";
	 $s=$conn->prepare($sql);
	 $s->bind_param("s",$id);
	 $s->bind_result($id,$name,$post,$details,$image,$bdate);
	 if($s->execute()){
		$s->fetch();
		$s->close();
}}
            ...
            <div class="container">
                <div class="row g-3 mb-3 align-items-center">
                    ...
                    <div class="col text-md-end">
                        <a class="btn btn-primary" href="our-team-dis.php"><i
                ...
                <div class="row g-3 clearfix row-deck">
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            ...
                            <form id="myForm" role="form" action="action/our-team.php" method="post"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <?php if($auto_Fill){ ?>
                                        <div class="col-md-12">
                                            <img class="img-table" src="../upload/team/<?php echo $image; ?>" width="50"
                                                height="50" />
                                        ...
                                        <div class="col-md-12">
                                            <label for="exampleInputEmail1">Video Link<span class="label label-danger"
                                                    id="pf_error"></span></label>
                                            <input type="text" required="" name="post"
                                                value="<?php if(!empty($post)){echo $post;}?>" class="form-control" />
