      ...
      <div class="container">
        <div class="row g-3 mb-3 align-items-center">
          ...
          <div class="col text-md-end">
            <a class="btn btn-primary" href="legal-add.php"><i class="fa fa-plus me-2"></i>Add</a>
            <button class="btn btn-danger btn-flat" onClick="Trush('manage_legal')"><i class="fa fa-trash"></i></button>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <tbody id="result">
                 <?php 
                 $i=1;
                  $sql="SELECT `id`, `cid`,`heading`,`url`, `image`, `cdate`, `cby` FROM `manage_legal`";
                 $s=$conn->prepare($sql);
                ...
                <tr id="row<?php echo $id; ?>" >
					...
					<td class="center"><a href="legal-add.php?id=<?php echo $id; ?>"><button class="btn btn-primary"><i class="fa fa-pencil"></i></button></a></td>
