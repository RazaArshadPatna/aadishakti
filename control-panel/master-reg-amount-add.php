...
if(isset($_GET['id'])){
     $auto_Fill=true;    
     $id=$_GET['id'];
     $sql="SELECT `id`,`heading1`,`amount`,`entry_time`,`entry_by`,`status`,`media` FROM `master_reg_amount` WHERE id=?";
     $s=$conn->prepare($sql);
     $s->bind_param("s",$id);
            ...
            <div class="container">
                <div class="row g-3 mb-3 align-items-center">
                    ...
                    <div class="col text-md-end">
                        <a class="btn btn-primary" href="master-reg-dis.php"><i
                ...
                <div class="row g-3 clearfix row-deck">
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            ...
                            <form id="myForm" role="form" action="action/master-reg-amount.php" method="post"
