      ...
      <div class="container">
        <div class="row g-3 mb-3 align-items-center">
          ...
          <div class="col text-md-end">
            <a class="btn btn-primary" href="our-team-add.php"><i class="fa fa-long-arrow-left me-2"></i>Add</a>

            <button class="btn btn-danger btn-flat" onClick="Trush('our_team')"><i class="fa fa-trash"></i></button>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-lg-12 col-md-12">
            <div class="card">
              ...
              <tbody>
				 ...
				 $sql="SELECT `id`, `name`, `post`,`media`, `cdate`, `cby` FROM `our_team`";
                 $s=$conn->prepare($sql);
                 $s->bind_result($id,$name,$post,$img,$cdate,$cby);
                 if($s->execute()){
				   while($s->fetch()){
                ...
                <tr class="gradeX" id="row<?php echo $id; ?>">   
                    ...
                    <td><img src="../upload/team/<?php echo $img; ?>" class="img-table" width="50" height="50" /></td>
                    <td><?php echo CusDate($cdate); ?></td>
                    <td><?php echo $cby; ?></td>
                    <td class="center"><a href="our-team-add.php?id=<?php echo $id; ?>"><button class="btn btn-primary"><i class="fa fa-edit"></i></button></a></td>
                </tr>
                <?php $i++;     
                     }
...
$('.menu-web-our-team').addClass("active");
</script>
 <script>
