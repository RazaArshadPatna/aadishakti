...
$form_title="Applied Online Courses";
...
<body class="layout-1" data-luno="theme-blue">
  ...
  <?php include './include/header.php'; ?>
      ...
      <div class="container">
        <div class="row g-3 mb-3 align-items-center">
         ...
         <div class="col text-md-end">
           <button class="btn btn-danger" onClick="Trush('apply_online')"><i class="fa fa-trash"></i></button>
          ...
          <div class="col-lg-12 col-md-12">
            <div class="card">
              ...
              <tbody>
                 ...
                 <?php 
				 $i=1;
				 $sql="SELECT `id`, `Name`, `mobile`, `Email`, `Details`, `service`, `entry_time` FROM `apply_online`";
	...
	<script>
  $('.menu-apply-tax').addClass("active");
