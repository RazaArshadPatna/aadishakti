...
<body class="layout-1" data-luno="theme-blue">
      ...
      <div class="container">
        <div class="row g-3 mb-3 align-items-center">
          ...
          <div class="col text-md-end">
            <!-- <a class="btn btn-primary" href="setting-add.php"><i class="fa fa-plus me-2"></i>Add</a> -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <tbody id="result">
                 <?php 
                 $i=1;
                 $sql="SELECT `id`,`heading1`,`value`,`entry_time`,`entry_by`,`status`,`media` FROM `setting` WHERE 1";
                 $s=$conn->prepare($sql);
                 $s->bind_result($id,$heading1,$value,$entry_time,$entry_by,$status,$media);
                 if($s->execute()){
                     $s->store_result();
                     while($s->fetch()){
                ...
                <tr id="row<?php echo $id; ?>">
                    ...
                    <td class="center"><a href="setting-add.php?id=<?php echo $id; ?>"><button class="btn btn-primary"><i class="fa fa-edit"></i></button></a></td>
  ...
  <script>
        ...
        $('.menu-web-master-setting').addClass("active");
</script>
 <script>
