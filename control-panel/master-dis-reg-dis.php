...
/* page info */
$form_title="Master Distributor Register Amount";
$module="Master";
?>
...
<body class="layout-1" data-luno="theme-blue">
      ...
      <div class="container">
        <div class="row g-3 mb-3 align-items-center">
          ...
          <div class="col text-md-end">
            <a class="btn btn-primary" href="master-dis-reg-amount-add"><i class="fa fa-plus me-2"></i>Add</a>
          <button class="btn btn-danger btn-flat" onClick="Trush('master_dis_reg_amount')"><i class="fa fa-trash"></i></button>
		  </div>
        </div>
      </div>
    </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <tbody id="result">
                 <?php 
                 $i=1;
                 $sql="SELECT `id`,`heading1`,`amount`,`entry_time`,`entry_by`,`status`,`media` FROM `master_dis_reg_amount` WHERE 1";
                 $s=$conn->prepare($sql);
                 $s->bind_result($id,$heading1,$amount,$entry_time,$entry_by,$status,$media);
                 if($s->execute()){
                     $s->store_result();
                     while($s->fetch()){
                ...
                <tr id="row<?php echo $id; ?>">
                    ...
                    <td class="center"><a href="master-dis-reg-amount-add.php?id=<?php echo $id; ?>"><button class="btn btn-primary"><i class="fa fa-edit"></i></button></a></td>
  ...
  <script>
        ...
        $('.menu-web-master-dis').addClass("active");
</script>
 <script>
