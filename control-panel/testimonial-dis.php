      ...
      <div class="container">
        <div class="row g-3 mb-3 align-items-center">
          ...
          <div class="col text-md-end">
            <a class="btn btn-primary" href="testimonial-add.php"><i class="fa fa-plus me-2"></i>Add</a>
            <button class="btn btn-danger btn-flat" onClick="Trush('testimonial')"><i class="fa fa-trash"></i></button>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-lg-12 col-md-12">
            <div class="card">
              ...
              <tbody>
				 ...
				 $sql="SELECT `id`, `name`, `profession`, `date_of_speak`,  `img`, `entry_time`, `entry_by` FROM `testimonial`";
                 $s=$conn->prepare($sql);
                 $s->bind_result($id,$name,$profession,$date_of_speak,$img,$entry_time,$entry_by);
                 if($s->execute()){
				   while($s->fetch()){
                ...
                <tr class="gradeX" id="row<?php echo $id; ?>">   
                    ...
                    <!-- <td><?php echo $date_of_speak; ?></td> -->
                    
                    <td><img src="../upload/testimonial/<?php echo $img; ?>" class="img-table" width="50" height="50" /></td>
                    <td><?php echo CusDate($entry_time); ?></td>
                    <td><?php echo $entry_by; ?></td>
                    <td class="center"><a href="testimonial-add.php?id=<?php echo $id; ?>"><button class="btn btn-primary"><i class="fa fa-edit"></i></button></a></td>
                </tr>
                <?php $i++;     
                     }
