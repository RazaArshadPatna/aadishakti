      ...
      <div class="container">
        <div class="row g-3 mb-3 align-items-center">
          ...
          <div class="col text-md-end">
            <a class="btn btn-primary" href="master-post-add.php"><i class="fa fa-plus me-2"></i>Add</a>
          <button class="btn btn-danger btn-flat" onClick="Trush('master_post')"><i class="fa fa-trash"></i></button>
		  </div>
        </div>
      </div>
    </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <tbody id="result">
                 <?php 
                 $i=1;
                 $sql="SELECT `id`,`heading1`,`entry_time`,`entry_by`,`status`,`media` FROM `master_post` WHERE 1";
                 $s=$conn->prepare($sql);
                ...
                <tr id="row<?php echo $id; ?>">
                    ...
                    <td class="center"><a href="master-post-add.php?id=<?php echo $id; ?>"><button class="btn btn-primary"><i class="fa fa-edit"></i></button></a></td>
